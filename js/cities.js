...
(function (global) {
  ...
  var CITIES = [
    // ישראל
    { id: 'jerusalem', name: 'ירושלים', lat: 31.7780, lon: 35.2354, elevation: 754, tz: 'Asia/Jerusalem', candleMinutes: 40, highCustom: true },
    ...
    { id: 'beer-sheva', name: 'באר שבע', lat: 31.2518, lon: 34.7913, elevation: 260, tz: 'Asia/Jerusalem', candleMinutes: 30 },
    { id: 'ashdod', name: 'אשדוד', lat: 31.8014, lon: 34.6435, elevation: 30, tz: 'Asia/Jerusalem', candleMinutes: 22 },
    { id: 'ashkelon', name: 'אשקלון', lat: 31.6688, lon: 34.5743, elevation: 40, tz: 'Asia/Jerusalem', candleMinutes: 30 },
    { id: 'netanya', name: 'נתניה', lat: 32.3215, lon: 34.8532, elevation: 30, tz: 'Asia/Jerusalem', candleMinutes: 30 },
    ...
    { id: 'beit-shemesh', name: 'בית שמש', lat: 31.7304, lon: 34.9886, elevation: 300, tz: 'Asia/Jerusalem', candleMinutes: 30, highCustom: true },
    { id: 'modiin-illit', name: 'מודיעין עילית', lat: 31.9333, lon: 35.0436, elevation: 290, tz: 'Asia/Jerusalem', candleMinutes: 30, highCustom: true },
    { id: 'beitar-illit', name: 'ביתר עילית', lat: 31.6969, lon: 35.1211, elevation: 700, tz: 'Asia/Jerusalem', candleMinutes: 40, highCustom: true },
    { id: 'elad', name: 'אלעד', lat: 32.0523, lon: 34.9512, elevation: 100, tz: 'Asia/Jerusalem', candleMinutes: 30 },
    { id: 'tzfat', name: 'צפת', lat: 32.9646, lon: 35.4960, elevation: 850, tz: 'Asia/Jerusalem', candleMinutes: 30 },
    { id: 'tiberias', name: 'טבריה', lat: 32.7922, lon: 35.5312, elevation: -200, tz: 'Asia/Jerusalem', candleMinutes: 30 },
    { id: 'eilat', name: 'אילת', lat: 29.5577, lon: 34.9519, elevation: 20, tz: 'Asia/Jerusalem', candleMinutes: 30 },
    // חו"ל
